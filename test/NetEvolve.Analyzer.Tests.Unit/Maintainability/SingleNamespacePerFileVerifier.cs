...
/// <summary>
/// Runs <see cref="SingleNamespacePerFileAnalyzer"/> against one or more <b>named</b> source files and,
/// optionally, a set of MSBuild build properties injected through a global analyzer config. Diagnostics are
/// declared inline with <c>{|NE0003:Identifier|}</c> markup.
/// </summary>
internal static class SingleNamespacePerFileVerifier
{
    ...
    {
        var test = new CSharpAnalyzerTest<SingleNamespacePerFileAnalyzer, DefaultVerifier>
        {
