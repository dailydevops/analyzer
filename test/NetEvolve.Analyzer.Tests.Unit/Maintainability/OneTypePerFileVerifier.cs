...
/// <summary>
/// Runs <see cref="OneTypePerFileAnalyzer"/> against one or more <b>named</b> source files (the analyzer is
/// file-name sensitive) and, optionally, a set of MSBuild build properties injected through a global
/// analyzer config. Diagnostics are declared inline with <c>{|NE0001:Identifier|}</c> markup.
/// </summary>
internal static class OneTypePerFileVerifier
{
