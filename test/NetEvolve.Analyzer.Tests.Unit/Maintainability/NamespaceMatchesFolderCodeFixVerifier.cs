...
/// <summary>
/// Applies <see cref="NamespaceMatchesFolderCodeFixProvider"/> to named source files (the rule is file-path
/// sensitive) and asserts the resulting set of files equals the expected fixed sources. Build properties are
/// injected through a global analyzer config, mirroring <see cref="NamespaceMatchesFolderVerifier"/>.
/// </summary>
internal static class NamespaceMatchesFolderCodeFixVerifier
{
