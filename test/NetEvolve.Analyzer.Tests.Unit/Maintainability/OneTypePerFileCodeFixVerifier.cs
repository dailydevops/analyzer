...
/// <summary>
/// Applies <see cref="OneTypePerFileCodeFixProvider"/> to named source files (the rule is file-name sensitive)
/// and asserts the resulting set of files equals the expected fixed sources. Build properties are injected
/// through a global analyzer config, mirroring <see cref="OneTypePerFileVerifier"/>.
/// </summary>
