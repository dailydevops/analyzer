...
/// <summary>
/// NE0007 — reports a <c>&lt;c&gt;</c> or <c>&lt;code&gt;</c> element inside an XML doc comment whose entire
/// content is a single recognized C# keyword (<see langword="true"/>, <see langword="false"/>,
/// <see langword="null"/>, …), which should instead use <c>&lt;see langword="..."/&gt;</c>. The whole
