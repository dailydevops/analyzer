...
| [NE0015](https://github.com/dailydevops/analyzer/blob/main/docs/rules/maintainability/ne0015.md) | Maintainability | Avoid a redundant `Clear()` on a freshly created collection                                          | Yes      |
